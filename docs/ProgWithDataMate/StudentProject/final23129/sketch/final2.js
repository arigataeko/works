const title = "女性の時間の使い方";
const keisu = 0.05;
let currentA = [];  //項目ごとの途中の角度
let imgSleep, imgWork, imgHouse, imgCare, imgLeisure;

function preload() {
  imgSleep = loadImage('./images/sleep2.png');
  imgWork = loadImage('./images/work2.png');
  imgHouse = loadImage('./images/house2.png');
  imgCare = loadImage('./images/care2.png');
  imgLeisure = loadImage('./images/leisure2.png');
}

function setup() {
  createCanvas(600, 300);
  Datamate.make("./data/femaletime.csv");  //行ヘッダが国名
